...
def _train_model_save(x_inner, y_inner, name):
    ...
    joblib.dump(clf_linear, "model_4cam/model_linear_" + name + ".m")
    end = time.time()
    ...
    joblib.dump(clf_rbf, "model_4cam/model_rbf_" + name + ".m")
    end = time.time()
    print("执行时间:", end - start)
    ...
    joblib.dump(clf_sigmoid, "model_4cam/model_sigmoid_" + name + ".m")
    end = time.time()
    print("执行时间:", end - start)
    '''
    print("进行决策树训练")
    ...
    joblib.dump(clf, "model_4cam/model_tree_" + name + ".m")
    end = time.time()
    print("执行时间:", end - start)
    ...
    joblib.dump(mlp, "model_4cam/model_mlp_" + name + ".m")
    end = time.time()
    print("执行时间:", end - start)
    ...
    joblib.dump(log_reg, "model_4cam/model_logreg_" + name + ".m")
    end = time.time()
    print("执行时间:", end - start)
...
def train_model(train_file_inner, input_frame_number_inner, input_label_delay_inner):
    ...
    with open(train_file_inner) as file:
        for line in file:
            ...
            data.append([tk for tk in tokens[2:30]])
            # print(data)
            if delay != 0:  # 推迟label
                delay -= 1
                continue
...
def cal_accuracy(test_file_inner, input_frame_number_inner, input_label_delay_inner):
    ...
    '''
    start = time.time()
    clf_linear_global = joblib.load("model_4cam/model_linear_global.m")
    ...
    print("执行时间:", end - start)
    start = time.time()
    clf_linear_upper = joblib.load("model_4cam/model_linear_upper.m")
    ...
    start = time.time()
    clf_rbf_global = joblib.load("model_4cam/model_rbf_global.m")
    ...
    print("执行时间:", end - start)
    start = time.time()
    clf_rbf_upper = joblib.load("model_4cam/model_rbf_upper.m")
    ...
    start = time.time()
    clf_sigmoid_global = joblib.load("model_4cam/model_sigmoid_global.m")
    ...
    print("执行时间:", end - start)
    start = time.time()
    clf_sigmoid_upper = joblib.load("model_4cam/model_sigmoid_upper.m")
    ...
    '''
    start = time.time()
    clf_tree_global = joblib.load("model_4cam/model_tree_global.m")
    ...
    print("执行时间:", end - start)
    start = time.time()
    clf_tree_upper = joblib.load("model_4cam/model_tree_upper.m")
    ...
    start = time.time()
    clf_logreg_global = joblib.load("model_4cam/model_logreg_global.m")
    ...
    print("执行时间:", end - start)
    start = time.time()
    clf_logreg_upper = joblib.load("model_4cam/model_logreg_upper.m")
    ...
    start = time.time()
    clf_mlp_global = joblib.load("model_4cam/model_mlp_global.m")
    ...
    print("执行时间:", end - start)
    start = time.time()
    clf_mlp_upper = joblib.load("model_4cam/model_mlp_upper.m")
...
if __name__ == '__main__':
    test_file = "test/test_4cam_scene1_02.csv"
    train_file = 'data/train_4cam_scene1_01.csv'
